---
name: roadmap
description: Roadmap do Larmony — v1 completo (M1–M9 + ADR-0020); v1.1 completo (M10 ✅, M11 ✅, M12 ✅); M13 Open Finance em espera com gatilho (ADR-0025); M14 Billing/Entitlements — ADR aceito (ADR-0026), backlog em execução
metadata:
  type: project
---
