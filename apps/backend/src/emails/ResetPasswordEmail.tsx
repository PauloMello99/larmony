...
export function ResetPasswordEmail({
  resetUrl = 'https://larmony.app/auth/reset-password?token=preview',
}: ResetPasswordEmailProps) {
  return (
    <Html lang="pt-BR">
      <Head />
      <Preview>Redefina sua senha do Larmony</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Recebemos uma solicitação para redefinir a senha da sua conta no Larmony. Clique
            ...
            <Text style={hint}>
              ...
              de senha, ignore este e-mail — sua conta permanece protegida.
            </Text>
          </Section>
