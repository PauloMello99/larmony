...
export const DOMAIN_CODE_TO_STATUS: Record<string, number> = {
  ...
  TRIAL_NOT_ALLOWED: HttpStatus.UNPROCESSABLE_ENTITY,
  HOUSEHOLD_LIMIT_REACHED: HttpStatus.PAYMENT_REQUIRED,
  MEMBER_LIMIT_REACHED: HttpStatus.PAYMENT_REQUIRED,
  GOAL_LIMIT_REACHED: HttpStatus.PAYMENT_REQUIRED,
  BUDGET_LIMIT_REACHED: HttpStatus.PAYMENT_REQUIRED,
