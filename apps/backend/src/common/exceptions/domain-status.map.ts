...
export const DOMAIN_CODE_TO_STATUS: Record<string, number> = {
  ...
  SOCIAL_PROVIDER_UNSUPPORTED: HttpStatus.BAD_REQUEST,
  SOCIAL_PROVIDER_NOT_CONFIGURED: HttpStatus.UNPROCESSABLE_ENTITY,
  SOCIAL_EMAIL_ALREADY_REGISTERED: HttpStatus.CONFLICT,
  EMAIL_ALREADY_REGISTERED: HttpStatus.CONFLICT,
  STATEMENT_IMPORT_JOB_NOT_FOUND: HttpStatus.NOT_FOUND,
  STATEMENT_IMPORT_CANDIDATE_NOT_FOUND: HttpStatus.NOT_FOUND,
  STATEMENT_IMPORT_CANDIDATE_NOT_PENDING: HttpStatus.CONFLICT,
  STATEMENT_IMPORT_DISABLED: HttpStatus.SERVICE_UNAVAILABLE,
};
