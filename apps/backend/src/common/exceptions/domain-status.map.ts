...
export const DOMAIN_CODE_TO_STATUS: Record<string, number> = {
  ...
  RECURRENCE_NOT_FOUND: HttpStatus.NOT_FOUND,
  RECURRENCE_START_DATE_IN_PAST: HttpStatus.UNPROCESSABLE_ENTITY,
  RECURRENCE_INVALID_DATE_RANGE: HttpStatus.UNPROCESSABLE_ENTITY,
};
