...
export class SubscriptionsController {
  ...
  checkout(
    ...
    return this.createCheckoutSession.execute(householdId, user.email);
  }

  @Post("portal")
  @UseGuards(HouseholdOwnerGuard)
  portal(@Param("householdId", ParseUUIDPipe) householdId: string) {
    return this.createPortalSession.execute(householdId);
  }
}
