...
export default function TermosDeUsoPage() {
  return (
    <>
      <PageSeo
        title="Termos de Uso · Larmony"
        description="Termos de Uso do Larmony: cadastro e responsabilidades da conta, planos pagos Essencial e Completo com teste grátis de 30 dias, cancelamento, direito de arrependimento (CDC art. 49) e uso aceitável do serviço."
