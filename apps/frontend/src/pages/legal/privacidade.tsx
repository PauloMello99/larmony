...
export default function PrivacidadePage() {
  return (
    <>
      <PageSeo
        title="Política de Privacidade · Larmony"
        description="Como o Larmony trata dados pessoais em conformidade com a LGPD: quais dados coletamos, finalidades e bases legais, operadores (Supabase, Stripe, Resend, Better Stack, Railway), retenção e seus direitos como titular."
