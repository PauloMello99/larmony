...
import { RecurrencesPage as RecurrencesPageContent } from "@/features/recurrences"
import { makeI18nProps } from "@/shared/lib/i18n"

const RecurrencesPage: NextPageWithLayout = () => <RecurrencesPageContent />

RecurrencesPage.getLayout = (page: ReactElement) => (
  <AuthGuard>
